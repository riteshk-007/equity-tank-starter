        ...
        <div className="flex flex-wrap -mx-4 lg:justify-between">
          <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
            <div className="mb-12 max-w-[570px] lg:mb-0">
              <span className="block mb-4 text-base font-semibold text-[#00c2cb]">
                Contact Us
              </span>
              <h2 className="text-black dark:text-white mb-6 text-[32px] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]">
                GET IN TOUCH WITH US
              </h2>
              <p className="text-base leading-relaxed text-black dark:text-gray-300 mb-9">
                We’d love to hear from you. Please fill out this form or shoot
                us an email.
              </p>
              <div className="mb-8 flex w-full max-w-[370px]">
                <div className="bg-[#00c2cb]/5 text-[#00c2cb] mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded sm:h-[70px] sm:max-w-[70px]">
                  <svg
                    width="32"
                    height="32"
                    viewBox="0 0 32 32"
                ...
                <div className="w-full">
                  ...
                  <p className="text-base text-black dark:text-gray-300">
                    2nd Floor, H-9, Street no.19, Main Rajapuri Rd, New Delhi,
                    Delhi 110059
                  </p>
                </div>
              </div>
            ...
            <div className="relative p-8 bg-white dark:bg-black rounded-lg shadow-lg border-2  sm:p-12">
              <form onSubmit={handleSubmit}>
                ...
                <div>
                  <button
                    type="submit"
                    className="w-full p-3 text-white transition border rounded border-primary bg-[#00c2cb] hover:bg-opacity-90"
                  >
                    Send Message
                  </button>
                </div>
