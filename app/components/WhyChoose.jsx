...
const WhyChoose = () => {
  return (
    <div className="text-[#2ec8d0] dark:text-[#00c2cb] w-full mx-auto flex items-center justify-center p-3 sm:p-4 md:p-5 flex-col bg-white dark:bg-gray-950">
      ...
      <p className="text-sm sm:text-md md:text-lg lg:text-xl font-semibold text-center text-[#2ec8d0] dark:text-[#00c2cb] p-3 sm:p-4 md:p-5 flex gap-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2  gap-3 sm:gap-4 md:gap-5 p-3 sm:p-4 md:p-5 ">
        {Services.map((service) => (
          ...
          >
            <span className="text-white rounded dark:text-white p-3 text-sm sm:text-md md:text-lg lg:text-2xl bg-[#2ec8d0] dark:bg-[#00c2cb]">
              {service.icon}
            </span>
          ...
          <div className="mx-auto  h-96">
            <div className="mx-auto container w-full flex flex-col justify-center items-center">
              <div className="flex justify-center items-center flex-col">
                <div className="mt-20">
                  <h2 className="lg:text-6xl md:text-5xl text-2xl font-black text-center leading-10 text-[#2ec8d0] dark:text-[#00c2cb] ">
                    Why Choose Us?
                  </h2>
                </div>
